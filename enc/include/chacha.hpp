...
class ChaCha20 {
    public:
        ...
        /* OPT 2 */
        void block_quarter_round_opt2(uint8_t result[64], uint32_t counter, uint32_t temp_c[16]);
        void encrypt_opt2(uint8_t *input, long len);
        void quarter_round_opt2(uint32_t *a, uint32_t *b, uint32_t *c, uint32_t *d);
        ...
        /* OPT 5 */
        void encrypt_opt5(uint8_t *input, long len);
};